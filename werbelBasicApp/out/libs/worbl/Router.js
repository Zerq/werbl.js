...
const Routmappinng_js_1 = require("./Routmappinng.js");
let Router = (() => {
    let _classDecorators = [(0, IOC_js_1.RegisterService)(types_js_1.IRouter)];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var Router = _classThis = class {
        constructor() {
            this.componentRegistry = IOC_js_1.IOC.Instance.Service(types_js_1.IComponentRegistry);
...
function Route(path) {
    return (ctor) => {
        const service = IOC_js_1.IOC.Instance.Service(types_js_1.IRouter);
        service.routeMappings.set(path, new Routmappinng_js_1.Routmappinng(ctor.name));
    };
}
