    ...
    View() {
        return JSX("article", null,
            ...
            JSX("p", null,
                ...
                JSX("br", null),
                JSX("br", null),
                "Than yay! that is what i was aiming for.",
                JSX("br", null),
                ...
                JSX("br", null),
                "Jquery became redundant as the standard ecmascript api evolved this project is basically here to see how far of are we from making thing like react and angular redundant.",
                JSX("br", null),
                JSX("br", null),
