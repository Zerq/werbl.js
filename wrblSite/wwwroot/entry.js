...
import "./Views/API/ApiView.js";
import "./Views/TechStack/TechStack.js";
import { IRouter } from "./libs/worbl/types.js";
let AppComponent = class AppComponent extends BasicAppRoot {
    Route(router) {
    }
    menuItems = [{ Name: "Home", Url: "#home" }, { Name: "API", Url: "#api" }, { Name: "Tech stack", Url: "#tech" }];
    constructor() {
        super();
    ...
    View() {
        return JSX("div", { class: "mainWrapper" },
            JSX("nav-box", { logo: "./assets/werbl.svg", title: " Werbl.js", items: this.menuItems }),
