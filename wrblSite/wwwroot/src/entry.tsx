...
export class AppComponent extends BasicAppRoot {
    ...
    protected menuItems: LinkLike[] = [{ Name: "Home", Url: "#home" }, { Name: "API", Url: "#api" }, { Name: "Tech stack", Url: "#tech"}];
    ...
    protected View(): HTMLElement {
        return <div class="mainWrapper"> 
            <nav-box logo="./assets/werbl.svg" title=" Werbl.js" items={this.menuItems}></nav-box>
            <main class="MyApp">
            </main>
        </div>;
    }
