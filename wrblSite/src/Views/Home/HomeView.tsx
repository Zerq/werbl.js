    ...
    protected View(): HTMLElement {
        ...
        return <article>
            ...
            <p>
                ...
                <br/>
                Than yay! that is what i was aiming for.<br/>
                ...
                Jquery became redundant as the standard ecmascript api evolved this project is basically here to see how far of are we from making thing like react and angular redundant.<br/>
                <br/>
